...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative size-full text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)] flex flex-row justify-between"
        style={{
          maskImage:
